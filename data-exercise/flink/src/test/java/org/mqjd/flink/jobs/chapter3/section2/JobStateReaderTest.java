...
public class JobStateReaderTest {
    ...
    public void testReadOperatorState() throws Exception {
        ...
        expectState.put(1, List.of(new CustomIteratorSourceSplit(0, 151, 4, 2)));
        expectState.put(2, List.of(new CustomIteratorSourceSplit(0, 152, 4, 3)));
        expectState.put(3, List.of(new CustomIteratorSourceSplit(0, 149, 4, 0)));
