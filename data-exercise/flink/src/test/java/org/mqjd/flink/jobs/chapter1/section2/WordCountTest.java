...
public class WordCountTest extends FlinkJobTest {
    ...
    static Stream<Arguments> given_incorrect_input_when_WordCount_then_exception_parameters() {
        return Stream.of(
            Arguments.arguments("empty args", new String[]{"--input", ""}, RuntimeException.class),
            Arguments.arguments("empty input", new String[]{"--input", ""},
    ...
    static Stream<Arguments> given_incorrect_output_when_WordCount_then_exception_parameters() {
        return Stream.of(Arguments.arguments("null output",
                new String[]{"--input", INPUT_PATH, "--output", null}, RuntimeException.class),
